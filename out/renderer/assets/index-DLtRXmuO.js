      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center gap-3", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "button",
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "material-symbols-outlined text-primary text-2xl", children: "shield" }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-lg font-black text-on-surface tracking-tighter uppercase", children: "Anti-Detech" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[10px] text-on-surface-variant font-mono ml-2", children: "v1.0" })
              ] })
            ]
          }
        ) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-1 max-w-sm mx-8", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "material-symbols-outlined absolute left-3 top-1/2 -translate-y-1/2 text-on-surface-variant text-[18px]", children: "search" }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
              ...
              children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "material-symbols-outlined text-[22px]", children: "notifications" })
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
              ...
              className: "p-2 text-on-surface-variant hover:bg-surface-container-high \n            hover:text-on-surface rounded-full transition-colors",
              "aria-label": "Settings",
              children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "material-symbols-outlined text-[22px]", children: "settings" })
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
              ...
              children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "material-symbols-outlined text-on-surface-variant text-[18px]", children: "person" })
            }
          )
        ] })
      ]
...
const Sidebar = ({ className = "" }) => {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "aside",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("nav", { className: "flex-1 space-y-0.5 px-3", children: NAV_ITEMS.map((item) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
          NavLink,
          {
            to: item.path,
            end: item.path === "/",
            className: ({ isActive }) => `flex items-center gap-3 py-3 px-4 rounded transition-all duration-200 text-sm font-medium
              ${isActive ? "text-primary bg-surface-container-high border-l-2 border-primary shadow-glow" : "text-on-surface-variant hover:bg-[rgba(0,255,255,0.08)] hover:text-primary border-l-2 border-transparent"}`,
            children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "p-5 border-t border-white/[0.05]", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-on-surface font-bold text-sm", children: "Anti-Detech" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-on-surface-variant text-[10px] uppercase tracking-widest mt-0.5", children: "Version v1.0" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "status-dot-active animate-pulse" })
        ] }) })
      ]
    }
  );
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col h-full", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "section",
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute top-0 right-0 w-1/2 h-full bg-gradient-to-l from-primary/[0.05] to-transparent pointer-events-none" }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex gap-4", children: stats.map((stat) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute top-0 right-0 w-16 h-16 bg-gradient-to-bl from-primary/[0.06] to-transparent" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[10px] font-semibold text-on-surface-variant uppercase tracking-wider mb-1", children: stat.label }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-2xl font-bold text-on-surface", children: stat.value }),
                  stat.isActive && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "status-dot-active animate-pulse" })
                ] })
              ]
            },
            stat.label
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "flex-1 overflow-auto p-8", children: [
...
const ProxyManager = () => {
  const [proxies] = reactExports.useState(PROXY_LIST);
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-8 max-w-[1400px] mx-auto h-full flex flex-col", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "h-[80px] flex items-center justify-between mb-8 shrink-0", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-2xl font-bold tracking-tight text-on-surface headline-sm", children: "Proxy Manager" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-on-surface-variant body-md", children: "Manage your centralized proxy pool" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-3", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "btn-secondary", children: "Import List" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { className: "btn-primary flex items-center gap-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "material-symbols-outlined text-lg", children: "add" }),
          "Add Proxy"
        ] })
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "grid grid-cols-1 md:grid-cols-3 gap-6 mb-10 shrink-0", children: [
    ...
    ].map((stat) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-surface-container-low p-5 rounded-xl relative overflow-hidden group", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: `absolute top-0 right-0 w-16 h-16 bg-gradient-to-bl from-${stat.color}/10 to-transparent` }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[0.6875rem] font-bold uppercase tracking-widest text-on-surface-variant mb-1", children: stat.label }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-end gap-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: `text-4xl font-black text-${stat.color === "primary" ? "on-surface" : stat.color} leading-none`, children: stat.value }),
        stat.dot && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: `w-2.5 h-2.5 rounded-full bg-${stat.color} mb-2 shadow-glow` })
      ] })
    ] }, stat.label)) }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "bg-surface-container-low rounded-xl overflow-hidden shadow-2xl flex-1 flex flex-col min-h-0", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-4 flex flex-wrap items-center justify-between gap-4 border-b border-white/[0.05] bg-surface-container shrink-0", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-4 flex-1 max-w-xl", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative flex-1", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "material-symbols-outlined absolute left-3 top-1/2 -translate-y-1/2 text-on-surface-variant text-lg", children: "search" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "input",
              {
                type: "text",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("select", { className: "bg-surface-container-highest border border-outline-variant/20 focus:ring-1 focus:ring-primary/30 rounded-lg py-2 pl-4 pr-10 text-sm text-on-surface cursor-pointer", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("option", { children: "All Protocols" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("option", { children: "HTTP" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("option", { children: "SOCKS5" })
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { className: "flex items-center gap-2 text-primary font-semibold text-sm hover:bg-primary/[0.05] border border-primary/20 px-4 py-2 rounded-lg transition-colors", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "material-symbols-outlined text-lg", children: "science" }),
          "Test All"
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "overflow-auto flex-1", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("table", { className: "w-full text-left border-collapse min-w-[800px]", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("thead", { className: "sticky top-0 bg-surface-container-low bg-opacity-95 backdrop-blur z-10", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "px-6 py-4 w-10", children: /* @__PURE__ */ jsxRuntimeExports.jsx("input", { type: "checkbox", className: "rounded border-outline-variant bg-surface-container-highest text-primary" }) }),
          ["Status", "Alias", "Protocol", "Host", "Port", "Auth", "Assigned", "Last Tested", "Actions"].map((col) => /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: `px-4 py-4 text-[10px] font-bold uppercase tracking-widest text-on-surface-variant ${col === "Actions" ? "text-right pr-6" : ""}`, children: col }, col))
        ] }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("tbody", { className: "divide-y divide-white/[0.05]", children: proxies.map((proxy) => /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { className: "group hover:bg-surface-bright transition-colors", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-6 py-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx("input", { type: "checkbox", className: "rounded border-outline-variant bg-surface-container-highest text-primary" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-3 py-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: `w-2.5 h-2.5 rounded-full ${proxy.testStatus === "active" ? "bg-tertiary shadow-glow-green" : "bg-error"}` }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-4 py-4 font-medium text-on-surface text-sm", children: proxy.alias }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-4 py-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: `text-[10px] px-1.5 py-0.5 rounded font-bold border ${proxy.protocol === "http" ? "bg-primary/10 text-primary border-primary/20" : "bg-secondary-container text-secondary border-secondary/20"}`, children: proxy.protocol.toUpperCase() }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-4 py-4 font-mono text-xs text-on-surface-variant", children: proxy.host }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-4 py-4 font-mono text-xs text-on-surface-variant", children: proxy.port }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-4 py-4 flex justify-center", children: proxy.username ? /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "material-symbols-outlined text-tertiary text-lg", children: "lock" }) : /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "material-symbols-outlined text-on-surface-variant/40 text-lg", children: "lock_open" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-4 py-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "bg-surface-container-highest px-2 py-0.5 rounded-full text-[10px] font-bold text-primary", children: "0" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: `px-4 py-4 text-[10px] font-medium ${proxy.testStatus === "failed" ? "text-error" : "text-on-surface-variant"}`, children: proxy.lastTested }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-6 py-4 text-right", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-end gap-2 opacity-0 group-hover:opacity-100 transition-opacity", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "p-1.5 text-primary hover:bg-primary/10 rounded-md transition-colors", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "material-symbols-outlined text-lg", children: "play_circle" }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "p-1.5 text-on-surface-variant hover:bg-surface-container-highest rounded-md transition-colors", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "material-symbols-outlined text-lg", children: "edit" }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "p-1.5 text-error hover:bg-error/10 rounded-md transition-colors", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "material-symbols-outlined text-lg", children: "delete" }) })
          ] }) })
        ] }, proxy.id)) })
      ] }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-4 bg-surface-container flex items-center justify-between text-[10px] font-semibold tracking-widest text-on-surface-variant uppercase shrink-0", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "px-3 py-1 bg-surface-container-highest rounded opacity-50 cursor-not-allowed", children: "Prev" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "px-3 py-1 bg-surface-container-highest rounded hover:bg-primary hover:text-on-primary-fixed transition-colors", children: "Next" })
        ] })
      ] })
    ] })
  ] });
...
const Automation = () => {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "h-full flex flex-col pt-4", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-8 pb-4 border-b border-white/[0.05] shrink-0", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-2xl font-bold tracking-tight text-on-surface mb-1", children: "Automation Scripts" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-on-surface-variant", children: "Manage and monitor your external Playwright/Puppeteer tasks" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-1 overflow-hidden", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "w-[320px] max-w-[35%] flex flex-col border-r border-white/[0.05] bg-surface-container-low/50", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-4 shrink-0 flex items-center justify-between", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-xs font-bold uppercase tracking-widest text-on-surface-variant", children: "Scripts" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "p-1 rounded hover:bg-surface-bright text-primary transition-colors", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "material-symbols-outlined text-[18px]", children: "add" }) })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "overflow-y-auto flex-1 divide-y divide-white/[0.03]", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-4 bg-surface-bright/50 border-l-2 border-primary cursor-pointer hover:bg-surface-bright", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between items-start mb-2", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm font-semibold text-on-surface", children: "Amazon_Auto_Review.js" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "status-dot-active animate-pulse mt-1" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-on-surface-variant line-clamp-2", children: "Navigates to Amazon, adds item to cart, leaves 5-star review using Profile Group A." }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-3 flex items-center gap-2", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[10px] font-mono bg-surface-container-highest px-1.5 py-0.5 rounded text-primary", children: "Node.js" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[10px] text-tertiary font-medium bg-tertiary/10 px-1.5 py-0.5 rounded border border-tertiary/20", children: "Running (12m)" })
            ] })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-4 hover:bg-surface-bright/30 border-l-2 border-transparent cursor-pointer transition-colors", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between items-start mb-2", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm font-semibold text-on-surface", children: "Shopee_Farm_Coins.py" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "w-2 h-2 rounded-full bg-outline-variant mt-1" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-on-surface-variant line-clamp-2", children: "Daily login script to collect Shopee coins on all VN profiles." }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-3 flex items-center gap-2", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[10px] font-mono bg-surface-container-highest px-1.5 py-0.5 rounded text-blue-400", children: "Python" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[10px] text-on-surface-variant font-medium", children: "Idle" })
            ] })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-4 hover:bg-surface-bright/30 border-l-2 border-transparent cursor-pointer transition-colors", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between items-start mb-2", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm font-semibold text-error", children: "Etsy_Mass_Listing.js" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "w-2 h-2 rounded-full bg-error mt-1" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-on-surface-variant line-clamp-2", children: "Uploads CSV product list to multiple Etsy accounts simultaneously." }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-3 flex items-center gap-2", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[10px] font-mono bg-surface-container-highest px-1.5 py-0.5 rounded text-primary", children: "Node.js" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[10px] text-error font-medium", children: "Failed" })
            ] })
          ] })
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 flex flex-col bg-surface", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-6 shrink-0 flex justify-between items-start border-b border-white/[0.05] bg-surface-container-highest/20", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-lg font-bold text-on-surface mb-1", children: "Amazon_Auto_Review.js" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-on-surface-variant font-mono", children: "/Users/helen/scripts/amazon_bot/main.js" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { className: "btn-secondary text-xs flex items-center gap-1.5", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "material-symbols-outlined text-[16px]", children: "stop" }),
              " Stop"
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { className: "btn-primary text-xs flex items-center gap-1.5", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "material-symbols-outlined text-[16px]", children: "edit" }),
              " Edit Config"
            ] })
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 p-6 relative bg-[#090b0e] overflow-hidden font-mono flex flex-col", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between items-center mb-4 shrink-0", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[10px] text-on-surface-variant uppercase tracking-widest font-bold font-sans", children: "Execution Logs" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "text-on-surface-variant hover:text-white transition-colors", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "material-symbols-outlined text-[16px]", children: "delete_sweep" }) })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 overflow-y-auto text-xs text-on-surface-variant space-y-2 pb-10", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-primary mr-3", children: "14:02:11" }),
              " [INFO] Starting script worker (PID 8392)..."
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-primary mr-3", children: "14:02:12" }),
              " [INFO] Connecting to CDP port 9222 for profile p1 (FB_Shop_Account_01)"
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-tertiary mr-3", children: "14:02:14" }),
              " [SUCCESS] Playwright attached to browser context."
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-primary mr-3", children: "14:02:15" }),
              " [INFO] Navigating to https://amazon.com ..."
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-primary mr-3", children: "14:02:18" }),
              ' [INFO] Page loaded. Searching query "gaming mouse".'
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-primary mr-3", children: "14:02:22" }),
              " [INFO] Clicking product id #B082XXXXX"
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-error mr-3", children: "14:02:25" }),
              " [WARN] Captcha detected. Awaiting manual resolution or 2captcha API..."
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "animate-pulse flex gap-1", children: [
...
const CookiesManager = () => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "h-full flex flex-col pt-4", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-8 pb-4 border-b border-white/[0.05] shrink-0", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-on-surface-variant", children: "Import, export, and manage session cookies for isolated profiles" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-1 overflow-hidden", children: [
...
const Settings = () => {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-8 mx-auto w-full h-full overflow-y-auto", style: { maxWidth: "800px" }, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "mb-10 mt-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-2xl font-bold tracking-tight text-on-surface mb-1", children: "Global Settings" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-on-surface-variant", children: "Configure application behavior, licenses, and API keys" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-6", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-surface-container border border-outline-variant/20 rounded-xl p-6 relative overflow-hidden", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute top-0 right-0 w-32 h-32 bg-gradient-to-bl from-primary/[0.03] to-transparent pointer-events-none" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-sm font-semibold uppercase tracking-widest text-on-surface-variant mb-5", children: "License Details" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between items-center bg-surface-container-low p-4 rounded-lg border border-white/[0.04]", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 mb-2", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-lg font-bold text-on-surface", children: "Anti-Detech Pro Plan" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[10px] font-bold uppercase tracking-wider bg-tertiary/10 text-tertiary px-2 py-0.5 rounded-full border border-tertiary/20", children: "Active" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-on-surface-variant font-mono", children: "Valid until: Dec 31, 2027" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "btn-secondary", children: "Renew License" })
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-surface-container border border-outline-variant/20 rounded-xl p-6 relative overflow-hidden", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-sm font-semibold uppercase tracking-widest text-on-surface-variant mb-5", children: "Application Settings" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between p-3 rounded hover:bg-surface-bright/50 transition-colors", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-medium text-on-surface", children: "Launch on startup" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[11px] text-on-surface-variant mt-0.5", children: "Start Anti-Detech automatically when you log into your computer" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative inline-flex items-center cursor-pointer", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("input", { type: "checkbox", className: "sr-only peer", defaultChecked: true }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-11 h-6 bg-surface-container-highest peer-focus:outline-none rounded-full peer peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all peer-checked:bg-primary shadow-inner" })
            ] })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between p-3 rounded hover:bg-surface-bright/50 transition-colors", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-medium text-on-surface", children: "Hardware Acceleration" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[11px] text-on-surface-variant mt-0.5", children: "Use GPU to render profiles (recommended)" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative inline-flex items-center cursor-pointer", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("input", { type: "checkbox", className: "sr-only peer", defaultChecked: true }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-11 h-6 bg-surface-container-highest peer-focus:outline-none rounded-full peer peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all peer-checked:bg-primary shadow-inner" })
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("hr", { className: "border-white/[0.05] my-2" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between p-3", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "text-sm font-medium text-on-surface w-1/3", children: "Default Browser Core" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("select", { className: "w-2/3 bg-surface-container-highest border border-outline-variant/30 rounded px-4 py-2 text-sm text-on-surface focus:ring-1 focus:ring-primary", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "chrome-114", children: "Chromium v114 (Recommended)" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "chrome-116", children: "Chromium v116" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "firefox", children: "Firefox ESR" })
            ] })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between p-3", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "text-sm font-medium text-on-surface w-1/3", children: "Local Data Directory" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "w-2/3 flex gap-2", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("input", { type: "text", readOnly: true, value: "/Users/helen/Library/Application Support/AntiDetech", className: "flex-1 bg-surface-container-highest border border-outline-variant/30 rounded px-4 py-2 text-xs font-mono text-on-surface-variant focus:ring-1 focus:ring-primary" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "btn-secondary", children: "Browse" })
            ] })
          ] })
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-surface-container border border-outline-variant/20 rounded-xl p-6 relative overflow-hidden", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-sm font-semibold uppercase tracking-widest text-on-surface-variant mb-1", children: "API Configuration" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-on-surface-variant mb-5", children: "Manage your local API port for external script integration (Playwright/Puppeteer)" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between p-3", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "text-sm font-medium text-on-surface w-1/3", children: "Local API Port" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("input", { type: "number", defaultValue: 9222, className: "w-2/3 bg-surface-container-highest border border-outline-variant/30 rounded px-4 py-2 text-sm font-mono text-on-surface focus:ring-1 focus:ring-primary" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between p-3", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "text-sm font-medium text-on-surface w-1/3", children: "Integration Key" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "w-2/3 flex gap-2", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative flex-1", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("input", { type: "password", readOnly: true, value: "1234567812345678", className: "w-full bg-surface-container-highest border border-outline-variant/30 rounded px-4 py-2 text-sm text-on-surface tracking-[0.2em] focus:ring-1 focus:ring-primary" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "absolute right-2 top-1/2 -translate-y-1/2 p-1 text-on-surface-variant hover:text-white transition-colors", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "material-symbols-outlined text-[16px]", children: "content_copy" }) })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "btn-secondary whitespace-nowrap", children: "Regenerate" })
            ] })
          ] })
        ] })
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between mt-8 pt-6 border-t border-white/[0.05] pb-20", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "text-xs font-semibold text-error hover:underline underline-offset-4", children: "Factory Reset Data" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { className: "btn-primary flex items-center gap-2 px-8", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "material-symbols-outlined text-[18px]", children: "save" }),
        "Save Changes"
      ] })
    ] })
  ] });
        ...
        "div",
        {
          ...
          children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("form", { onSubmit: handleSubmit, children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-8 py-6 grid grid-cols-2 gap-6", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "col-span-2", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "block text-xs font-semibold text-on-surface-variant uppercase tracking-wider mb-2", children: "Profile Name *" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "input",
                    {
                      name: "name",
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "block text-xs font-semibold text-on-surface-variant uppercase tracking-wider mb-2", children: "Browser Core" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs(
                    "select",
                    {
                      name: "browserCore",
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "block text-xs font-semibold text-on-surface-variant uppercase tracking-wider mb-2", children: "Proxy" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs(
                    "select",
                    {
                      name: "proxyId",
                      ...
                      children: [
                        ...
                        /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "proxy-us", children: "US-NYC-Static-01 (HTTP)" }),
                        /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "proxy-vn", children: "VN-HCM-Resi-99 (SOCKS5)" }),
                        /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "proxy-de", children: "DE-Berlin-Datacenter (HTTP)" })
                      ]
                    }
                  )
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "col-span-2", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "block text-xs font-semibold text-on-surface-variant uppercase tracking-wider mb-2", children: "User Agent" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-2", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "input",
                      {
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "block text-xs font-semibold text-on-surface-variant uppercase tracking-wider mb-2", children: "Tags" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "input",
                    {
                      name: "tags",
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "col-span-2", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "block text-xs font-semibold text-on-surface-variant uppercase tracking-wider mb-2", children: "Notes" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "textarea",
                    {
                      name: "note",
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(BrowserRouter, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex h-screen bg-surface overflow-hidden", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("main", { className: "ml-[240px] pt-[60px] flex-1 overflow-hidden bg-surface-container-low", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-full overflow-auto", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Routes, { children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        ...
        {
          path: "/proxy",
          element: /* @__PURE__ */ jsxRuntimeExports.jsx(ProxyManager, {})
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        Route,
        {
          path: "/automation",
          element: /* @__PURE__ */ jsxRuntimeExports.jsx(Automation, {})
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        Route,
        {
          path: "/cookies",
          element: /* @__PURE__ */ jsxRuntimeExports.jsx(CookiesManager, {})
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        Route,
